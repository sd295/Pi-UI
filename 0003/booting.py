...
total_frames = 24 * 1 * 1  # 2 minutes * 60 seconds/minute * 60 frames/second
...
while frame_index < total_frames:
    ...
    text = font.render("pi os 0.0.0.3", True, (255, 255, 255))
    ...
    # Adjust the frame rate (e.g., 1 frame per second)
    clock.tick(4)
...
os.system(f"python {open_file_path}")
